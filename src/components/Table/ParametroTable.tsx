...
export const ParametroTable = ({ params, origenes, handleChange }: Props) => {
      ...
      <Table sx={{ width: 300 }} aria-label="customized table">
        ...
        <TableRow>
          <TableCell sx={{ p: 0 }} align='center'>
            <Checkbox checked={identificaDuplicadosOrigen1} onChange={handleChange} name="identificaDuplicadosOrigen1" size='small' />
          </TableCell>
          <TableCell sx={{ p: 0 }} align='center'>
            <Checkbox checked={identificaNoMatchOrigen1} onChange={handleChange} name="identificaNoMatchOrigen1" size='small' />
          </TableCell>
          <TableCell sx={{ p: 0 }} align='center'>
        ...
        <TableRow>
          <TableCell sx={{ p: 0 }} align='center'>
            <Checkbox checked={identificaDuplicadosOrigen2} onChange={handleChange} name="identificaDuplicadosOrigen2" size='small' />
          </TableCell>
          <TableCell sx={{ p: 0 }} align='center'>
            <Checkbox checked={identificaNoMatchOrigen2} onChange={handleChange} name="identificaNoMatchOrigen2" size='small' />
          </TableCell>
          <TableCell sx={{ p: 0 }} align='center'>
